...
class EasyPayRecorrente extends EasyPayClient
{
    /**
    ...
    /**
     * Define um id de um plano no EasyPay.
     *
     * @param string $plan
     *
     * @return $this
    ...
    /**
     * Define um code de uma pré-aprovação no EasyPay.
     *
     * @param string $plan
     *
     * @return $this
    ...
    {
        $senderEmail = $this->sandbox ? 'teste@sandbox.EasyPay.com.br' : $this->sanitize($senderInfo, 'senderEmail');
